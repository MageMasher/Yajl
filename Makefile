...
YAJL_CFLAGS = -I/usr/local/include
YAJL_LDFLAGS = $(shell $(PKG_CONFIG) yajl --libs)
YAJL_SWIFTCFLAGS = -I /usr/local/include
...
CFLAGS = $(strip $(cflags) $(OTHER_CFLAGS) $(YAJL_CFLAGS))
LDFLAGS = $(strip $(ldflags) $(OTHER_LDFLAGS) $(YAJL_LDFLAGS))
SWIFTCFLAGS = $(strip $(swiftcflags) $(OTHER_SWIFTCFLAGS) $(YAJL_SWIFTCFLAGS))
...
################################
XCODEPROJ_CFLAGS  = -Xcc '-I$$(SRCROOT)/Sources/YajlConfig/include'
...
list-undoc: docs
	./Tools/list_undoc docs/undocumented.json
